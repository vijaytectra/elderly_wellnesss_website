      ...
      <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3 md:items-center">
        ...
        <div className="md:text-right">
          <button
            ...
            className="inline-flex items-center rounded-full bg-[color:var(--color-brand)] px-8 py-3 text-sm font-semibold text-[color:var(--color-brand-foreground)] shadow-[var(--shadow-card)] transition hover:bg-[color:var(--color-brand-dark)] disabled:cursor-not-allowed disabled:opacity-60"
          >
